...
- Use the following shell processing pattern to fetch the markdown profile, strip the YAML headers, and prepend the Gemini Guardrails:
- Exec: `sh .gemini/commands/fetch-agent.sh <URL> <agent-name>`
